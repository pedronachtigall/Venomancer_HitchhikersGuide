...
![](./figures/TransCompPlot.png){width=75% height=75%}
...
![](./figures/toxin_transcript_heatmap.png){width=75% height=75%}
...
![](./figures/toxin_class_heatmap.png){width=75% height=75%}
...
![](./figures/toxin_PCA.png){width=75% height=75%}
